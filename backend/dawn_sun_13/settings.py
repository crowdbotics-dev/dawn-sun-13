"""
Django settings for dawn_sun_13 project.
...
WSGI_APPLICATION = 'dawn_sun_13.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dawn_sun_13 API",
    "DESCRIPTION": "API documentation for dawn_sun_13 App",
    "VERSION": "v1",
}
